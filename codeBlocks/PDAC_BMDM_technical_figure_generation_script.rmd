...
DataPath <- "C:/My_Drive/MS/SCoPE/t-SCoPE/Pub/Data_Share/FigureGen/"
...
# Your paths here
###
FigOut <- "C:/My_Drive/MS/SCoPE/t-SCoPE/code/pSCoPE_pubFigs/figs/TEST_SCRIPT_OUT_PDAC2/"
datOut <- "C:/My_Drive/MS/SCoPE/t-SCoPE/code/pSCoPE_pubFigs/figs/TEST_SCRIPT_OUT_PDAC2/"

# Missing data at single-cell level

PDAC_t0_both <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/t0_PDAC_consist_PIF50_mrri10.txt"))

PDAC_MP_both <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Prot_missing_PDAC_consist_PIF50_mrri10.txt"))

PDAC_CG_both <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/ChanKey_PDAC_consist_PIF50_mrri10.txt"))

AllExps <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/ev_PDAC_consist_filtered_PIF50_mrri10_1pFDR.txt"))
...
evi.tier.s <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_evidence_Shotgun.txt"))
evi.tier.p <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_evidence_pSCoPE.txt"))
...
RefList <- read.csv(paste0(DataPath,"technicalfigs_PDAC/Consistency/TierAssignmentOfDDAPeps_PDAC_110521.csv"))
...
TargList <- read.delim(paste0(DataPath,"tLists/PDAC_1x_Uniform_1105_3.txt"))
...
PDAC_CG_both.f <- PDAC_CG_both %>% dplyr::filter(celltype == "sc", cvm < .4)
...
TargList_Both.m.pep_sums <- TargList_Both.pep_in.m %>% group_by(pep) %>% summarize(numCells = sum(Valbin, na.rm = TRUE)) %>% arrange(-numCells) %>% filter(numCells != 0)
...
PDAC_CG_s <- PDAC_CG_both %>% filter(Raw.file %in% ShotgunSet, cvm < .4, celltype == "sc")
PDAC_CG_p <- PDAC_CG_both %>% filter(!(Raw.file %in% ShotgunSet), cvm < .4, celltype == "sc")
...
PDAC_t0_both.m_Top_sum_MD <- PDAC_t0_both.m_Top_sum %>% group_by(variable) %>% summarize(FractionMD = sum(is.na(valSumNa))/n())
PDAC_t0_both.m_All_sum_MD <- PDAC_t0_both.m_All_sum %>% group_by(variable) %>% summarize(FractionMD = sum(is.na(valSumNa))/n())
...
evi.cov <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_evidence_Shotgun.txt"))
evi.cov_lim <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_evidence_pSCoPE.txt"))
msmsS.cov <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_msmsScans_Shotgun.txt"))
msmsS.cov_lim <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_msmsScans_pSCoPE.txt"))
msms.cov <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_msms_Shotgun.txt"))
msms.cov_lim <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/Coverage_msms_pSCoPE.txt"))
...
CG.cov <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/ChanKey_PDAC_cov_PIF50_mrri10.txt"))
CG.cov$Raw.file <- str_sub(CG.cov$Raw.file, start = 2)

MDp.cov <- read.delim(paste0(DataPath, "technicalfigs_PDAC/Coverage/Prot_missing_PDAC_cov_PIF50_mrri10.txt")) 
```
...
```{r}
CG.s.cov.f <- CG.cov %>% dplyr::filter(celltype == "sc",cvm <.4, Raw.file %in% PDAC_cov_ShotgunSet)
CG.p.cov.f <- CG.cov %>% dplyr::filter(celltype == "sc",cvm <.4, Raw.file %in% PDAC_cov_PrioriSet)
...
PDAC_coverage_targList <- paste0(DataPath,"tLists/PDAC_Scout_2x_DDA_Final.txt")
PDAC_coverage_log_path <- paste0(DataPath,"/MQL_log_files/Coverage/")
...
PDAC_consistency_targList <- "C:/My_Drive/MS/SCoPE/t-SCoPE/TLists/11_05_2021/PDAC_1x_Uniform_1105_3.txt"
PDAC_consistency_log_path <- "C:/My_Drive/MS/SCoPE/t-SCoPE/dat/PDAC_tier_102921/MQLive_Logs/"
...
#------------------------
consist_shotgun <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_msms_Shotgun.txt"))
consist_priori <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_msms_pSCoPE.txt"))
...
consist_shotgun_evi <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_evidence_Shotgun.txt"))
consist_priori_evi <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Consistency/Consistency_evidence_pSCoPE.txt"))
...
#------------------------
targList_instance_consist <- read.delim(paste0(DataPath,"tLists/PDAC_1x_Uniform_1105_3.txt"))
...
BMDM_CG <- read.delim(paste0(DataPath,"technicalfigs_BMDM/ChanKey_BMDM_20Shotgun20pSCoPE_mrri02_PIF50_DART_FDR1p.txt"))
...
BMDM_t0 <- read.delim(paste0(DataPath,"technicalfigs_BMDM/t0_BMDM_20Shotgun20pSCoPE_mrri02_PIF50_DART_1pFDR.txt")) 
...
BMDM_MDp <- read.delim(paste0(DataPath,"technicalfigs_BMDM/Prot_missing_BMDM_20Shotgun20pSCoPE_mrri02_PIF50_DART_1pFDR.txt"))
  
#BMDM_tList <- read.delim("C:/My_Drive/MS/SCoPE/t-SCoPE/TLists/08_10_2021/CEO_TargList_081021_2.txt")
BMDM_tList <- read.delim(paste0(DataPath,"tLists/CEO_TargList_081021_2.txt"))
...
BMDM_ev <- read.delim(paste0(DataPath,"technicalfigs_BMDM/ev_20Shotgun20pSCoPE_02182022_mrri02_PIF50_DART_1pFDR.txt"))
...
BMDM_tList_4FT_1 <- read.delim(paste0(DataPath,"tLists/CEO_TargList_081021_2.txt"))
...
# Showing abundance
pSCoPE_evi_4FT <- read.delim(paste0(DataPath,"technicalfigs_BMDM/ev_20Shotgun20pSCoPE_02182022_mrri02_PIF50_DART_1pFDR.txt"))
...
```{r}
###
# Fig 1d: PCA plots for PDAC cell type and Protein-set color-coding
###

CG <- read.delim(paste0(DataPath,"technicalfigs_PDAC/Coverage/","ChanKey_PDAC_coverage_PIF50_mrri10.txt"))
BC_data <- read.csv(paste0(DataPath,"technicalfigs_PDAC/Coverage/","limmaCorrected_normed_prePCA_PDAC_cov_PIF50_mrri10.csv"))
...
cellType_PDAC_PCA <- PDAC_PC_coord.anno %>% ggplot(aes(x = PC1, y = PC2, color = cellLab)) + geom_point(shape =16,size = 5, alpha = 0.50) + theme_light() +labs(color = "", x = paste0("PC1 (",round(PC1_fracVar,2)*100,"%)"), y = paste0("PC2 (",round(PC2_fracVar,2)*100,"%)")) + scale_color_manual(values = c(Okabe_Ito[1],Okabe_Ito[2],Okabe_Ito[3])) + 
  geom_text(aes(x = 0, y = 14),size = 8,color = Okabe_Ito[3],label = "HPAF-II") + 
  geom_text(aes(x = 18, y = 0),size = 8,color = Okabe_Ito[2],label = "CFPAC-I") + 
  geom_text(aes(x = -14, y = 0),size = 8,color = Okabe_Ito[1],label = "BxPC-3") + theme(legend.position = "null",axis.title = element_text(size = 24), axis.text = element_text(size = 20)) 

ProtMissing <- read.delim(paste0(singleCellDir,"Prot_missing_PDAC_consist_PIF50_mrri10.txt"))
BC_dat <- read.csv(paste0(singleCellDir,"limmaCorrected_normed_prePCA_PDAC_PIF50_mrri10.csv"))

ProtMissing.m <- melt(ProtMissing)
BC_dat.m <- melt(BC_dat, by = "X")
...
ggsave(paste0(FigOut,"PDAC_PCA_composite.pdf"), width = 16, height = 5, units = "in") 
```

```{r}
###
# PC-based PSEA applied to pSCoPE PDAC sets from Fig 1b
###

GOPath <- "biofigs_BMDM/"
GO_DB_Path <- paste0(DataPath,GOPath,"GOA_db.txt")
...
# Limited protein set presentation
...
ggsave(paste0(FigOut,"PSEA_PDAC_Coverage_pSCoPE_only.png"), width = 10, height = 15, units = "in")

# Full protein set presentation
PDAC_PSEA.f_fdr  %>% ggplot(aes(x = PC, y = str_wrap(Process, width = 50),fill = round(Association,1), size = neglogq_bin)) + geom_point(shape = 21, stroke = 1) + scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, breaks = c(-1,0,1)) + theme_light() + labs(fill = "Loading\nz-score",x = "Principal component",y = "", size = bquote("-log"[10]~"(q val)")) + theme(axis.text.y = element_text(size = 16),axis.text.x = element_text(size = 26),axis.title = element_text(size = 30), legend.title = element_text(size = 20), legend.text = element_text(size = 15), legend.position = "bottom", legend.box="vertical", legend.margin=margin()) +
  scale_size_continuous(breaks = seq(2,3,1),range=c(1,15),
                  limits = c(0, 4), labels = c("2",">3")) +  scale_x_discrete(limits = c("1",
     "2","3","4"), expand=c(0.1, 0)) 
ggsave(paste0(FigOut,"PSEA_PDAC_Coverage_pSCoPE_only_fullPS.png"), width = 10, height = 15, units = "in")
```
