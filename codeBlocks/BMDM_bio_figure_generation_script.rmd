...
CorPermutation <- function(df,CodingDoc,dbString){
    ...
    CS_permTest$qVal <- p.adjust(CS_permTest$fraction)
...
datPath <- "C:/My_Drive/MS/SCoPE/t-SCoPE/Pub/codeBlocks/BMDM_bio_output_test/"
...
GeneMappings_single <- read.csv("C:/My_Drive/MS/SCoPE/t-SCoPE/code/pSCoPE_pubFigs/BatchCorrection_examination/GeneMappings.csv")
...
GO_DB_Path <- "G:/My Drive/MS/DBs_Params/GO/alt/GOA_db.txt"
...
DIA_Bulk <- read.delim("C:/My_Drive/MS/SCoPE/t-SCoPE/dat/MEROPS_bulk_120421/GHRT_eGH692_Report.xls")

figOut <- "C:/My_Drive/MS/SCoPE/t-SCoPE/code/pSCoPE_pubFigs/figs/TEST_SCRIPT_OUT/"
datOut <- "C:/My_Drive/MS/SCoPE/t-SCoPE/code/pSCoPE_pubFigs/figs/TEST_SCRIPT_OUT/"
...
#write.table(xcond2,paste0(datOut,"xCond2.txt"))
...
xcond2 <- read.table(paste0(datOut,"xCond2.txt"))
...
xcond.f <- xcond2 %>% filter(!is.na(pVal))
...
#Ratio_markOut <- read.table(paste0(figOut,"Ratio_markOut.txt"))
#SCoPE2_markOut <- read.table(paste0(figOut,"SCoPE2_markOut.txt"))
