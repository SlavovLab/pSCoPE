...
ggsave(paste0(FigOut,"Fig1b_consistency_coverage_MQLcontrast.pdf"), width = 7, height = 5, units = "in")
...
ggsave(paste0(FigOut,"Fig1c_Rebuttal_coverage_MQliveStats_Legend.pdf"), width = 7, height = 5, units = "in")
...
ggsave(paste0(FigOut,"Fig2a_Coverage_Rebuttal_rev2_1pFDRMS2.pdf"), width = 7.2 , height = 5.1, units = "in")
...
ggsave(paste0(FigOut,"Fig2b_IntensityCurve_Rebuttal.pdf"), width = 7, height = 5, units = "in")
```
...
cellHeatMap2
ggsave(paste0(FigOut,"Fig2c_TierHeatMap_Rebuttal_patchwork_fig_v4_noBlank.pdf"), width = 6.2 , height = 5, units = "in")
```
...
ggsave(paste0(FigOut,"Fig2d_Pep_ProtMD_consistency_Rebuttal_fig_v4_completeness.pdf"), width = 7.5 , height = 5.1, units = "in")
```
...
ggsave(paste0(FigOut,"Fig2e_HEK_Mel_PCA_composite_v2.pdf"), width = 16, height = 5.33, units = "in") 
...
ggsave(paste0(FigOut,"Fig3a_SpikeInRII_violin_v2.pdf"), width = 7, height = 5, units = "in")
```
...
ggsave(paste0(FigOut,"Fig3b_RegressionAllData_RISeqComb_StandardFill_MedandPoints_v3_adjScale.pdf"), width = 7, 
       height = 7, units = "in")
...
```{r BMDM PSEA test}
#************
# Uncomment to Run PC-weight-based PSEA (PC weights, reference database, number of PCs to evaluate)
...
#************
# Comment out when running PSEA function above 
#************
...
ggsave(paste0(FigOut,"Fig4a_xCond_PSEA_PCs_horiz_v3.pdf"), width = 6, height = 4.5, units = "in")
```
...
ggsave(paste0(FigOut,"Fig4a_celltypePlusBulk.pdf"), width = 5, height = 5, units = "in")
```
...
ggsave(paste0(FigOut,"Fig4b_xCond_PC_PSEA_legendBottom.pdf"), width = 7.75, height = 10, units = "in")
```
...
Scatter
ggsave(paste0(FigOut,"Fig_S2_ScatterRevised_supplemental_v2.png"), width =11, height = 11, units = "in")
...
ScatterFig4
ggsave(paste0(FigOut,"Fig4c_ScatterRevised.pdf"), width =5, height = 5, units = "in", device = cairo_pdf)
...
ProtonPumpPair
ggsave(paste0(FigOut,"Fig4d_ProtonPumpPair.pdf"), width = 7, height = 5, units = "in", device = cairo_pdf)
...
ggsave(paste0(FigOut,"FigS3_ProtonPump_CorHeat_Supplemental.pdf"), width = 11, height = 7.33, units = "in", device = cairo_pdf)
...
ggsave(paste0(FigOut,"Fig5a_CondComp_PC_PSEA_v3.pdf"), width = 9, height = 9, units = "in")
```
...
ggsave(paste0(FigOut,"Fig5a_ProtonPCA_v2.pdf"), width = 8, height = 4, units = "in")
```
...
ggsave(paste0(FigOut,"Fig5b_LPS_DexVolcano_wide_v5_SelectLabs2.pdf"), width =8, height = 4, units = "in")
```
...
ggsave(paste0(FigOut,"Fig5b_LPS_DextranSort_wide_LPS_percent.pdf"), width = 8.15, height = 4.2, units = "in")
...
ggsave(paste0(FigOut,"Fig5b_EndoPCA_v3_forSCoPE_BluetoRed_wide_colorCoded.pdf"), width = 9, height = 5, units = "in")
```
...
ggsave(paste0(FigOut,"Fig6b_Internal_and_SCoPE2_DB_MEROPS_v8.pdf"), width = 9, height = 5.25)
```
...
ggsave(paste0(FigOut,"Fig6a_BulkAndSC_Val_v3_2part_v4.pdf"), width = 4, height = 5.25)
```
...
ggsave(paste0(FigOut,"Fig6c_MEROPS_PCA_Fig2E_v2.pdf"), width = 10, height = 4.25, units = "in")

((ActL299_F1_v2) + plot_spacer() + (ActL104_v2)) + plot_layout(widths = c(1,0.5,1), guides = "collect") & theme(legend.position = "right")
ggsave(paste0(FigOut,"Fig6c_MEROPS_PCA_Fig2E_v2_legend.pdf"), width = 10, height = 4.25, units = "in")
```
...
ggsave(paste0(FigOut,"EDF1_Rebuttal_contrast_MQliveStats.pdf"), width = 7, height = 8, units = "in")
```
...
ggsave(paste0(FigOut,"EDF2_Fig2_ShotgunCVs.png"), width = 7, height = 5, units = "in")
...
pSCoPECVs_fig2a %>% ggplot(aes(x = cvm, fill = colorCode)) + geom_density(alpha=0.5, adjust=.7) + theme_light() + coord_cartesian(xlim = c(0,1))  + scale_x_continuous(limits = c(0,1)) +
  geom_vline(xintercept = .4, linetype = "dashed", size = 1, color = "grey50") +
  scale_fill_manual(values=c("purple","grey10")) + theme_pubr() + labs(x = "Quantification Variability, CV", y = "Density") + theme(legend.title = element_blank(), axis.text = element_text(size = 14), axis.title = element_text(size = 16))
ggsave(paste0(FigOut,"EDF2_Fig2s_pSCoPECVs.png"), width = 7, height = 5, units = "in")
...
pSCoPECVs_fig2bcde %>% ggplot(aes(x = cvm, fill = colorCode)) + geom_density(alpha=0.5, adjust=.7) + theme_light() + coord_cartesian(xlim = c(0,1))  + scale_x_continuous(limits = c(0,1)) +
  geom_vline(xintercept = .4, linetype = "dashed", size = 1, color = "grey50") +
  scale_fill_manual(values=c("purple","grey10")) + theme_pubr() + labs(x = "Quantification Variability, CV", y = "Density") + theme(legend.title = element_blank(), axis.text = element_text(size = 14), axis.title = element_text(size = 16))
ggsave(paste0(FigOut,"EDF2_Fig2bcde_pSCoPECVs.png"), width = 7, height = 5, units = "in")
...
pSCoPECVs_fig4_5_6 %>% ggplot(aes(x = cvm, fill = colorCode)) + geom_density(alpha=0.5, adjust=.7) + theme_light() + coord_cartesian(xlim = c(0,1))  + scale_x_continuous(limits = c(0,1)) +
  geom_vline(xintercept = .4, linetype = "dashed", size = 1, color = "grey50") +
  scale_fill_manual(values=c("purple","grey10")) + theme_pubr() + labs(x = "Quantification Variability, CV", y = "Density") + theme(legend.title = element_blank(), axis.text = element_text(size = 14), axis.title = element_text(size = 16))
ggsave(paste0(FigOut,"EDF2_Fig4_5_6_pSCoPECVs.png"), width = 7, height = 5, units = "in")
```
...
ggsave(paste0(FigOut,"EDF3_PSMs1pFDR_PEPHistogram_forPub_Rebut.pdf"), width = 8, height = 6, units = "in")
...
ggsave(paste0(FigOut,"EDF3_PSMs1pFDR_fragHistogram_forPub_Rebut.pdf"), width = 8, height = 6, units = "in")  
...
ggsave(paste0(FigOut,"EDF3_PSMs1pFDR_PEPDensity_forPub_Rebut.pdf"), width = 6, height = 6, units = "in")
...
Coverage_shotgun_evi.f.t2_sum3 %>% filter(Priority %in% c(4,3)) %>% ggplot(aes(medianFrag, color = IDd)) + geom_density(position = position_identity(), alpha = 0.5, lwd = 2) + theme_light()  + labs(x = "Number of Matching Fragments", y = "Prioritized Precursors, Density", color = "", fill = "") + coord_flip() + theme(axis.text.x = element_text(angle = 45, hjust = 1),
  ...
  #ggtitle("Shotgun PSM Properties: Matching Fragments") + 
  facet_wrap(~"Top Two Priority Levels")
ggsave(paste0(FigOut,"EDF3_PSMs1pFDR_FragDensity_forPub_Rebut.pdf"), width = 6, height = 6, units = "in")

```
# EDF 4: MQ.live log stats for Fig2 experiments
```{r}
...
ggsave(paste0(FigOut,"EDF4_Rebuttal_SC_MQliveStats.pdf"), width = 7, height = 8, units = "in")
```
...
ggsave(paste0(FigOut,"EDF5_IMBR_contrast_Top.pdf"), width = 7, height = 5, units = "in")

IMBR_contrast_box 
ggsave(paste0(FigOut,"EDF5_IMBR_contrast_bottom.pdf"), width = 7, height = 5, units = "in")
...
ggsave(paste0(FigOut,"EDF6a_BMDM_missingData_v2_mrri02.pdf"), width = 9 , height = 7, units = "in")
...
ggsave(paste0(FigOut,"EDF6b_BMDM_DataPointsPerCell_mrri02.pdf"), width = 7, height = 7, units = "in")
...
ggsave(paste0(FigOut,"EDF6c_BMDM_IncreasedFillTimes_mrri02.pdf"), width = 7, height = 7, units = "in")
...
celltype_unImp 
ggsave(paste0(FigOut,"EDF7_unimp_PCA_celltype_header.pdf"), width = 5.5, height = 5.5, units = "in")
...
ggsave(paste0(FigOut,"EDF7_unimp_PCA_PSEA_footer_select.pdf"), width = 5.5, height = 3.75, units = "in")
```
...
MD_pca_plot
ggsave(paste0(FigOut,"EDF8_DataCompleteness_PCA_supplemental.pdf"), width = 7, height = 7, units = "in")
```
...
ggsave(paste0(FigOut,"EDF10_NT_DexVolcano_wide_v5_SelectLabs2.pdf"), width =8, height = 4, units = "in")
...
ggsave(paste0(FigOut,"EDF10_EndoPCA_NT_v3_forSCoPE_BluetoRed_wide_colorCoded.pdf"), width = 9, height = 5, units = "in")
...
ggsave(paste0(FigOut,"FigS1_PrecursorIntHistogram.pdf"), height = 7, width = 7, units = "in")
...
ContingencyOut %>% filter(Platform != "Shotgun") %>% ggplot(aes(x = as.numeric(Start), y = meanFreq, color = Platform, group = Platform)) +
  ...
  labs(x =bquote('Log'[10]~ 'Precursor Intensity'), y = "Precursors", color = "") +
  coord_flip()
ggsave(paste0(FigOut,"FigS1_PrecursorIntHistogram_side.pdf"), height = 6, width = 8, units = "in")
